This project use swagger : outputs could be seen end tests at http://localhost:8080/q/swagger-ui/




# quarkus-capacitytool-test Project
...
You can then execute your native executable with: `./target/quarkus-capacitytool-test-1.0-SNAPSHOT-runner`
